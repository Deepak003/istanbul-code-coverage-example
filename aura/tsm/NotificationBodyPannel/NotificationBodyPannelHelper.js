({
    ...
    constructArticleParameter : function(component, event, selectedUrl, helper){
        //Defining the parser
        var paramsSolr = {};
        ...
        //Defaulting the options to article only
        paramsSolr['q.options'] = '{"defaultOperator":"and",fields:["article_no"]}';
        ...
        this.generateAWSResponse(component, event, endPoint, helper);
    },
    ...
    generateAWSResponse : function(component, event, endPoint, helper){
                ...
                if (xmlHttp.status === 200) {
                    ...
                    if(articleResult.hits != undefined){
                        if(articleResult.hits.found > 0){
                            helper.loadKnowledgeBaseWindow(component, event, articleResult.hits.hit[0]);
                        }
                    }
                }
            }

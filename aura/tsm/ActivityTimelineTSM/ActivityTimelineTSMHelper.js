({
            ...
            if (state === "SUCCESS") {
                ...
                for (var i=0; i<caseNotes.length; i++) {
                    ...
                    if(caseNotes[i].caseAction != 'undefined'){
                        caseNotes[i].iconType = iconList[caseNotes[i].caseAction];
                    }               
                }
    ...
    getCurrentCaseActivities: function(component, event){
        ...
        action.setCallback(this, (response)=> {
            ...
            if (state === "SUCCESS") {
            	...
            	let formatData = this.formatResponse(data);
                component.set("v.caseUpdatesList", formatData.slice(0, 3));

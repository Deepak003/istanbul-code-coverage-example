...
var GrantEntitlementModalController = require('../../../aura/tsm/GrantEntitlementModal/GrantEntitlementModalController.js');

var GrantEntitlementModalController = require('../../../aura/tsm/GrantEntitlementModal/GrantEntitlementModalController.js');

describe("GrantEntitlementModalController", function() {
	let component, event, helper;
    beforeEach(function() {
    	component = jasmine.createSpyObj('component', ['set', 'find', 'get', 'getElement']);
    	event = jasmine.createSpyObj('event', ['getSource', 'getParam']);
    	helper = jasmine.createSpyObj('helper', ["fetchData", "formatProductForLookup"]);
    })
    ...
    describe('doInit', function() {
        ...
        it('should call the helper method formatProductForLookup & fetchData', function() {
            
            GrantEntitlementModalController.doInit(component, event, helper);

            expect(helper.formatProductForLookup).toHaveBeenCalledWith(component);
            expect(helper.fetchData).toHaveBeenCalledWith(component);
        });        
    });

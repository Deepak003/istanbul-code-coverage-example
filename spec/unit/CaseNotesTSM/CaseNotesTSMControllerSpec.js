...
const Util = jasmine.createSpyObj('Util', ['handleSuccess', 'handleErrors', 'repairDate', 'fetchNotes']);

/* const target = 'CaseNotesTSM/CaseNotesTSMController.js';

const CaseNotesTSMController = vm.runInNewContext(
    fs.readFileSync(path.join(rootPath, '.', 'aura', 'tsm', target)), {$A, Util}
); */
var CaseNotesTSMController = require('../../../aura/tsm/CaseNotesTSM/CaseNotesTSMController.js');


var CaseNotesTSMController = require('../../../aura/tsm/CaseNotesTSM/CaseNotesTSMController.js');

describe("CaseNotesTSMController", function() {
	let component, event, helper;
    beforeEach(function() {
        component = jasmine.createSpyObj('component', ['set', 'find', 'get', 'getElement']);
        event = jasmine.createSpyObj('event', ['getSource', 'getParam']);        
        helper = jasmine.createSpyObj('helper', ['pullTabInfo', 'setTabInfo', 'fetchNotes']);

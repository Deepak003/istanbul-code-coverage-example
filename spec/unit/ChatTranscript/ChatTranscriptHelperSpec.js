...
var ChatTranscriptHelper = require('../../../aura/tsm/ChatTranscript/ChatTranscriptHelper.js');

var ChatTranscriptHelper = require('../../../aura/tsm/ChatTranscript/ChatTranscriptHelper.js');

describe("ChatTranscriptHelper", function() {
    ...
    beforeEach(function() {
        ...
        Object.assign(component, {
	        ...
	        get: jasmine.createSpy('get').and.callFake((arg)=> {
	        	if(arg == 'v.caseId') {
                    return "123456789";
                }else if(arg == 'c.fetchChatTranscriptsByCaseId'){
                    return action;
        ...
        Object.assign(action, {
            setCallback: jasmine.createSpy('setCallback').and.callFake((arg, arg1)=> {
                if(typeof arg1 == 'function'){
                    arg1.call(ChatTranscriptHelper, response);
                }
            })
        });
    ...
    describe('pullTranscripts', ()=> {
        it('should call apex methods with correct parameters', ()=>{
            ChatTranscriptHelper.pullTranscripts(component);
            expect(action.setParams).toHaveBeenCalledWith({caseId: "123456789", caseNumber: "1234567890"});        
        });

        it('should call setCallback', ()=>{
            ChatTranscriptHelper.pullTranscripts(component);
            expect(action.setCallback).toHaveBeenCalledWith(ChatTranscriptHelper, jasmine.any(Function));
        });

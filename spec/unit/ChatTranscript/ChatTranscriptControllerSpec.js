...
var ChatTranscriptController = require('../../../aura/tsm/ChatTranscript/ChatTranscriptController.js');

var ChatTranscriptController = require('../../../aura/tsm/ChatTranscript/ChatTranscriptController.js');

describe("ChatTranscriptController", function() {
    ...
    describe('doInit', function() {
        it('should call helper methods', function() {
            ChatTranscriptController.doInit(component, event, helper);
